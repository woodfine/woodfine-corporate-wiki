# Woodfine Deployment: woodfine-corporate-wiki
...
**Infrastructure-as-Code (IaC) configuration for the Internal Corporate Knowledge Base deployment.**
...
* **Target VM:** `vm-woodfine-corporate-wiki'
* **Base OS Image:** `mediakit-os` (Flavor: `app-knowledge`)
* **Public URL:** `https://corporate.woodfinegroup.com`
